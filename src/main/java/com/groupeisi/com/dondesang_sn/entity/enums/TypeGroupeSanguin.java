...
public enum TypeGroupeSanguin {
    ...
    public static StatutDemande fromValue(Object TypeGroupeSanguin) {
        if (TypeGroupeSanguin instanceof Map) {
            ...
            if (mapTypeDemande.containsKey("name")) {
                return StatutDemande.valueOf(mapTypeDemande.get("name").toString());
            }
        }
        if (TypeGroupeSanguin instanceof String) {
            return StatutDemande.valueOf(TypeGroupeSanguin.toString());
        }
